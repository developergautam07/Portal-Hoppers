...
PLAY_COLLIDER = pygame.Rect(0, 0, 30, 30)
...
ENEMY_COLLIDER = pygame.Rect(0, 0, 30, 30)
ENEMY_HEALTH = 100
ENEMY_ATTACK = ra.randint(1,3)
print(ENEMY_ATTACK)
ENEMY_HIT = 5
E_DISTANCE = 70         # Distance from each other in px
ENEMY_RANGE = 400
STOP_RANGE = 200
...
WEAPONS["pistol"] = {"bullet_vel":500, "bullet_life": 700, "rate": 500, "pushback": 40, "accuracy": 5,
                         "damage": 10, "b_size": "L", "n_bullet": 1}
WEAPONS["shotgun"] = {"bullet_vel":400, "bullet_life": 300, "rate": 900, "pushback": 100, "accuracy": 20,
                         "damage": 7, "b_size": "S", "n_bullet": 8}
